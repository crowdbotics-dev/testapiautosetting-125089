...
## Project Structure
    ...
    ├── testapiautosetting_125089  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_125089`
...
2. Clone this repo and `cd testapiautosetting_125089`
